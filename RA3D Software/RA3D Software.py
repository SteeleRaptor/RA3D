...
class TkWindow(Tk):
    ...
    def createWidgets(self):
        ...
        # Offsets
        self.offsetLabel = Label(self.controlFrame, text="Joint Offsets")
        self.offsetLabel.grid(row=3, column=1, columnspan=2, padx=5, pady=5)
        # Make the widgets
        self.J1OffsetLabel = Label(self.controlFrame,text="J1:")
        self.J1OffsetEntry = Entry(self.controlFrame, width=4)
        self.J2OffsetLabel = Label(self.controlFrame,text="J2:")
        self.J2OffsetEntry = Entry(self.controlFrame, width=4)
        self.J3OffsetLabel = Label(self.controlFrame,text="J3:")
        self.J3OffsetEntry = Entry(self.controlFrame, width=4)
        self.J4OffsetLabel = Label(self.controlFrame,text="J4:")
        self.J4OffsetEntry = Entry(self.controlFrame, width=4)
        self.J5OffsetLabel = Label(self.controlFrame,text="J5:")
        self.J5OffsetEntry = Entry(self.controlFrame, width=4)
        self.J6OffsetLabel = Label(self.controlFrame,text="J6:")
        self.J6OffsetEntry = Entry(self.controlFrame, width=4)
        # Grid the widgets
        self.J1OffsetLabel.grid(row=4, column=1, padx=5, pady=5)
        self.J1OffsetEntry.grid(row=4, column=2, padx=5, pady=5)
        self.J2OffsetLabel.grid(row=4, column=3, padx=5, pady=5)
        self.J2OffsetEntry.grid(row=4, column=4, padx=5, pady=5)
        self.J3OffsetLabel.grid(row=4, column=5, padx=5, pady=5)
        self.J3OffsetEntry.grid(row=4, column=6, padx=5, pady=5)
        self.J4OffsetLabel.grid(row=5, column=1, padx=5, pady=5)
        self.J4OffsetEntry.grid(row=5, column=2, padx=5, pady=5)
        self.J5OffsetLabel.grid(row=5, column=3, padx=5, pady=5)
        self.J5OffsetEntry.grid(row=5, column=4, padx=5, pady=5)
        self.J6OffsetLabel.grid(row=5, column=5, padx=5, pady=5)
        self.J6OffsetEntry.grid(row=5, column=6, padx=5, pady=5)
        ...
        self.moveLabel.grid(row=6, column=1, columnspan=2, padx=5, pady=5)
        # Send command button
        self.sendCommandButton = Button(self.controlFrame, text="Send Command", command=self.sendMoveCommand)
        self.sendCommandButton.grid(row=6, column=3, columnspan=3, padx=5, pady=5)
        ...
        # Display them
        self.xCoordLabel.grid(row=7, column=1, padx=5, pady=5)
        self.xCoordEntry.grid(row=7, column=2, padx=5, pady=5)
        self.yCoordLabel.grid(row=7, column=3, padx=5, pady=5)
        self.yCoordEntry.grid(row=7, column=4, padx=5, pady=5)
        self.zCoordLabel.grid(row=7, column=5, padx=5, pady=5)
        self.zCoordEntry.grid(row=7, column=6, padx=5, pady=5)
        self.RxCoordLabel.grid(row=8, column=1, padx=5, pady=5)
        self.RxCoordEntry.grid(row=8, column=2, padx=5, pady=5)
        self.RyCoordLabel.grid(row=8, column=3, padx=5, pady=5)
        self.RyCoordEntry.grid(row=8, column=4, padx=5, pady=5)
        self.RzCoordLabel.grid(row=8, column=5, padx=5, pady=5)
        self.RzCoordEntry.grid(row=8, column=6, padx=5, pady=5)

        # Current Position label
        self.currentPosLabel = Label(self.controlFrame, text="Current:")
        self.currentPosLabel.grid(row=9, column=1, columnspan=2, padx=5, pady=5)
        ...
        # Display them
        self.xCurCoordLabel.grid(row=10, column=1, padx=5, pady=5)
        self.xCurCoord.grid(row=10, column=2, padx=5, pady=5)
        self.yCurCoordLabel.grid(row=10, column=3, padx=5, pady=5)
        self.yCurCoord.grid(row=10, column=4, padx=5, pady=5)
        self.zCurCoordLabel.grid(row=10, column=5, padx=5, pady=5)
        self.zCurCoord.grid(row=10, column=6, padx=5, pady=5)
        self.RxCurCoordLabel.grid(row=11, column=1, padx=5, pady=5)
        self.RxCurCoord.grid(row=11, column=2, padx=5, pady=5)
        self.RyCurCoordLabel.grid(row=11, column=3, padx=5, pady=5)
        self.RyCurCoord.grid(row=11, column=4, padx=5, pady=5)
        self.RzCurCoordLabel.grid(row=11, column=5, padx=5, pady=5)
        self.RzCurCoord.grid(row=11, column=6, padx=5, pady=5)
